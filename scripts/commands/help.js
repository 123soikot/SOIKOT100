...
module.exports.handleEvent = function ({ api, event, getText }) {
	...
	return api.sendMessage(getText("moduleInfo", command.config.name, command.config.description, `${prefix}${command.config.name} ${(command.config.usages) ? command.config.usages : ""}`, command.config.category, command.config.cooldowns, ((command.config.hasPermssion == 0) ? getText("user") : (command.config.hasPermssion == 1) ? getText("adminGroup") : getText("adminBot")), command.config.credits), threadID, messageID);
}
...
module.exports. run = function({ api, event, args, getText }) {
    ...
    const text = `╭──────╮\n✅✅ 𝐏𝐀𝐆𝐄   ✅✅\n╰──────╯ (${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)})\nType: "${prefix}help 🥀command name🥀" for more details about that command\n\nCurrently available ${arrayInfo.length} command on Bot ${global.config.BOTNAME}\n\n╭────────╮\n🙈 𝗡𝗔𝗠𝗘 𝗢𝗪𝗡𝗘𝗥 🙈\n╰────────╯\nBOT PREFIX=${prefix}\n╭──────╮\n★彡[Ex 卝 বয়ফ্রেন্ডヅ]彡★\n╰──────╯
    \n🥵✅🥀𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥 𝗙𝗕 𝗜𝗗🥵✅🥀\n\n[𝗔𝗡𝗬 𝗛𝗘𝗟𝗣 𝗖𝗢𝗡𝗧𝗔𝗖𝗧 𝗙𝗕]\n\n🍁🍂https://www.facebook.com/mdsakhoyat.hosen.9?mibextid=ZbWKwL🍂🍁 \n\n╭───────╮\n🥵𝗙𝗢𝗥 𝗛𝗔𝗧𝗘𝗥𝗦👿\n╰───────╯\n𝗙𝗘𝗘𝗟 𝗧𝗛𝗘 𝗣𝗢𝗪𝗘𝗥 𝗢𝗙 ★彡[Ex 卝 বয়ফ্রেন্ডヅ]彡★`;
